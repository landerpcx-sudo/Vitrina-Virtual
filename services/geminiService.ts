...
const generateSingleImage = async (
  ...
  const prompt = `
    ...
    **1. IDENTIDAD FACIAL INALTERABLE (Regla de Prioridad ABSOLUTA E INNEGOCIABLE):**
        ...
        *   **TERMINANTEMENTE PROHIBIDO:** No rejuvenezcas, embellezcas, simetrices, idealices o alteres el rostro de NINGUNA manera. NO INVENTES RASGOS. NO CAMBIES LA LÍNEA DE LA MANDÍBULA. NO ALTERES LA SONRISA. Si la persona se ve cansada, seria, o no está perfectamente maquillada en la original, DEBE verse exactamente igual en la final. El objetivo es el **realismo crudo**, no la perfección.
